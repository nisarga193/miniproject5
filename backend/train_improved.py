"""
Improved training script with data augmentation and balanced batches
to ensure robust model performance across all classes.
"""
import os
import argparse
import numpy as np
...
class AudioAugmentation:
    ...
    @staticmethod
    def frequency_mask(mel_spec, max_mask_pct=0.1, num_masks=1):
